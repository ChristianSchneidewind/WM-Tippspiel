...
{
    /// <inheritdoc />
    public partial class AddTeamsPlayersMatchEvents : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KickOff = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "TEXT", nullable: false),
                    HomeTeamTipp = table.Column<int>(type: "INTEGER", nullable: false),
                    AwayTeamTipp = table.Column<int>(type: "INTEGER", nullable: false),
                    points = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tipps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Tipps_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tipps_Games_GameId",
                        column: x => x.GameId,
